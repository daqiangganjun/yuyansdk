...
object LX17PinYinUtils {
    ...
    init {
        ...
        lx17PinyinMap.put("MF", "mou,sou,miu")
        ...
        lx17PinyinMap.put("QY", "qing,eng")
        lx17PinyinMap.put("QG", "ei")
        lx17PinyinMap.put("QW", "e")
        lx17PinyinMap.put("QJ", "i")
        lx17PinyinMap.put("QN", "an")
        lx17PinyinMap.put("QC", "qiang")
        lx17PinyinMap.put("QQ", "qian")
        lx17PinyinMap.put("QG", "qun,ei")
        lx17PinyinMap.put("QF", "qiu,ou")
        lx17PinyinMap.put("QT", "er")
